...
export const testRoute: ServerRoute = {
  method: 'GET',
  path: '/slack/test',
  options: {
...
export const slackGamesHqCommandRoute: ServerRoute = {
  method: 'POST',
...
export const slackRoutes: ServerRoute[] = [testRoute, slackGamesHqCommandRoute];
